...
public class ResponsableEconomicoDTOTest {
  ...
  public void testResponsableEconomicoDTOCreation() {
    assertNotNull(
      responsable,
      "El objeto ResponsableEconomicoDTO debería ser creado correctamente."
    );
  }
  ...
  public void testSetNombreCompleto() {
    ...
    assertEquals(
      "Laura Rodriguez",
      responsable.getNombreCompleto(),
      "El nombre completo debería actualizarse a 'Laura Rodriguez'."
    );
  }
  ...
  public void testSetDocumentoIdentificacion() {
    ...
    assertEquals(
      "987654321",
      responsable.getDocumentoIdentificacion(),
      "El documento de identificación debería actualizarse a '987654321'."
    );
  }
  ...
  public void testSetCorreoElectronico() {
    ...
    assertEquals(
      ...
      responsable.getCorreoElectronico(),
      "El correo electrónico debería actualizarse a 'laura.rodriguez@example.com'."
    );
  }
  ...
  public void testSetTelefono() {
    ...
    assertEquals(
      "555-4321",
      responsable.getTelefono(),
      "El teléfono debería actualizarse a '555-4321'."
    );
  }
  ...
  public void testSetDireccion() {
    ...
    assertEquals(
      ...
      responsable.getDireccion(),
      "La dirección debería actualizarse a 'Avenida Siempre Viva 742'."
    );
  }
}
