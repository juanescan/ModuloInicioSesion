...
public class ResponsableEconomicoTest {
    ...
    public void testResponsableEconomicoCreation() {
        ResponsableEconomico responsable = ResponsableEconomico.builder()
        ...
        assertNotNull(responsable, "El objeto ResponsableEconomico debería ser creado correctamente.");
    ...
    public void testObtenerDetallesResponsableEconomico() {
        ...
        String detallesEsperados = "Nombre Completo: Carlos Gutierrez - Documento Identificación: 123456789 - Correo Electrónico: carlos.gutierrez@example.com - Teléfono: 555-1234 - Dirección: Calle Falsa 123";
        assertEquals(detallesEsperados, responsable.obtenerDetallesResponsableEconomico(), "Los detalles del responsable económico deberían coincidir con el formato esperado.");
    }
}
