...
public class EstudianteDTOTest {
    ...
    public void testEstudianteDTOCreation() {
        assertNotNull(estudiante, "El objeto EstudianteDTO debería ser creado correctamente.");
    }
    ...
    public void testSetNombreUsuario() {
        ...
        assertEquals("nuevoUsuario", estudiante.getNombreUsuario(), "El nombre de usuario debería actualizarse a 'nuevoUsuario'.");
    }

    @Test
    public void testSetContrasena() {
        estudiante.setContrasena("nuevaPassword");
        assertEquals("nuevaPassword", estudiante.getContrasena(), "La contraseña debería actualizarse a 'nuevaPassword'.");
    }

    @Test
    public void testSetNombreCompleto() {
        estudiante.setNombreCompleto("Carlos Lopez");
        assertEquals("Carlos Lopez", estudiante.getNombreCompleto(), "El nombre completo debería actualizarse a 'Carlos Lopez'.");
    }

    @Test
    public void testSetCodigoEstudiante() {
        estudiante.setCodigoEstudiante("EST54321");
        assertEquals("EST54321", estudiante.getCodigoEstudiante(), "El código de estudiante debería actualizarse a 'EST54321'.");
    }

    @Test
    public void testSetCurso() {
        estudiante.setCurso("Ciencias");
        assertEquals("Ciencias", estudiante.getCurso(), "El curso debería actualizarse a 'Ciencias'.");
    }

    @Test
    public void testSetAnoAcademico() {
        estudiante.setAnoAcademico("2025");
        assertEquals("2025", estudiante.getAnoAcademico(), "El año académico debería actualizarse a '2025'.");
    }

    @Test
    public void testSetResponsableId() {
        estudiante.setResponsableId("RESP123");
        assertEquals("RESP123", estudiante.getResponsableId(), "El ID del responsable debería actualizarse a 'RESP123'.");
    }
}
