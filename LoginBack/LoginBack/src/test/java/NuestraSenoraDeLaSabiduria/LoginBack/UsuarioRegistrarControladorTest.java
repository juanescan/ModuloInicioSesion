...
class UsuarioRegistrarControladorTest {
    ...
    void testValidarResponsableEconomico() {
        ...
        when(usuarioServicio.validarResponsable(responsableEconomico)).thenReturn(true);

        // Llamada al método de prueba
        boolean resultado = usuarioRegistrarControlador.validarResponsableEconomico(responsableEconomico);
    ...
    void testRegistrarResponsableEconomico() {
        // Configuración de datos de prueba
        ResponsableEconomicoDTO responsableEconomicoDTO = new ResponsableEconomicoDTO("pepitoPerez","1234123","pepito@mail.com","32342412","cra 72bis #12 - 2");
        ...
        ResponsableEconomico responsableEconomico = ResponsableEconomico.builder()
        ...
        // Configuración del comportamiento del servicio
        when(usuarioServicio.registrarResponsable(any(ResponsableEconomico.class))).thenReturn(responsableEconomico);

        // Llamada al método de prueba
        ResponsableEconomico resultado = usuarioRegistrarControlador.registrarResponsableEconomico(responsableEconomicoDTO);
    ...
    void testRegistrarEstudiante() {
        // Configuración de datos de prueba
        EstudianteDTO estudianteDTO = new EstudianteDTO("pepito","123","PepitoPerez","12345","once","2024","padrePepito");
        ...
        // Configuración del comportamiento del servicio
        when(usuarioServicio.registrarEstudiante(any(Estudiante.class))).thenReturn(estudiante);

        // Llamada al método de prueba
        Usuario resultado = usuarioRegistrarControlador.registrarEstudiante(estudianteDTO);
    ...
    void testRegistrarBibliotecario() {
        // Configuración de datos de prueba
        BibliotecarioDTO bibliotecarioDTO = new BibliotecarioDTO("pepito","123","pepitoPerez");
        ...
        // Configuración del comportamiento del servicio
        when(usuarioServicio.registrarBibliotecario(any(Bibliotecario.class))).thenReturn(bibliotecario);

        // Llamada al método de prueba
        Usuario resultado = usuarioRegistrarControlador.registrarBibliotecario(bibliotecarioDTO);
